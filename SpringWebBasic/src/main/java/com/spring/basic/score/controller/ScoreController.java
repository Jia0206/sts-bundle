...
public class ScoreController {
	...
	*/
	...
	public String list(Model model) {
		...
		//컨트롤러는 서비스에 의존하기 때문에 겟 리스트를 하면 서비스 창에 
		//둥록이 됨 
	}
		...
		//서비스한테 일 시켜야지 
   		...
   		/*
   		 ...
   		 갱신된 목록을 불러오는 요청이 다시금 들어올 수 있도록 유도를 하자 -> sendRedirect()
   		  ...
   		  "redirect:[URL]"을 작성하면 내가 지정한 URL로 자동
   		  재 요청이 일어나면서 미리 준비해 둔 로직을 수행할 수 있다. 
   		  점수 등록 완료 => 목록을 달라는 요청으로 유도 -> 목록을 응답. 
   		 */
