...
<body>
	...
	<script>
		...
		function regist(){
			...
			-> FormData 객체를 활용합니다.
			무조건 이 방식이 옳은 것은 아닙니다. FormData는 비동기 방식이 꼭 필요한 경우에만 
			사용합니다. 대부분의 경우에는 form태그를 이용해서 전송하는 방식이 더 간편하고 
			더 자주 사용됩니다. 
			...
			*/
			...
			//FormData 객체를 보낼 때는 따로 headers설정을 진행하지 않습니다. 
