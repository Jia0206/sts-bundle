            ...
            <div class="col-lg-6 col-md-9 col-sm-12 join-form">
                ...
                <form action="/myweb/user/join" method="post" name="joinForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="userName" class="form-control" id="pwConfirm" placeholder="비밀번호를 확인해주세요.">
...
<script>
    ...
    document.getElementById('idCheckBtn').onclick = function () {
        ...
        /*
            ...
            - promise 객체를 자동으로 리턴하여 손쉽게 통신의 응답데이터를 소비할 수 
            있게 해줍니다 .
    ...
    id.onkeyup = function () {
        ...
        */
        ...
        // test(문자열) -> 정규표현식의 규칙에 어긋나지 않는 문자라면 true,  
        // 어긋난다면 false.
